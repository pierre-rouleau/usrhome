#!/bin/sh
# SH FILE: setfor-bash-config.bash
#
...
# ------------------
#
# This file holds the persistent user settings for the Bash Shell controlled
# by USRHOME.  This file is a *template* provided as an example.
#
...
# export BASH_ENV=/Users/roup/my/dv/usrhome/dot/bash_profile.bash
...
case $(hostname -s) in
    "macStudio1" )
        ...
        export USRHOME_DIR="$HOME/my/dv/usrhome"
        ;;

    "macBookAir" )
        export USRHOME_DIR_MY="$HOME"
        export USRHOME_DIR_DV="$HOME/dev"
        export USRHOME_DIR_PUB="$HOME/devpub"
        export USRHOME_DIR_PRIV="$HOME/devpriv"

        # The last one is USRHOME_DIR, which defines the root of the usrhome directory
        # It is first set by execution of setup/setup-usrhome.
        export USRHOME_DIR="$HOME/dev/usrhome"
        ;;
    "iMac2" )
        export USRHOME_DIR_MY="$HOME"
        export USRHOME_DIR_DV="$HOME/dev"
    ...
    "kali-gnu-linux-2023" )
        export USRHOME_DIR_MY="$HOME"
        export USRHOME_DIR_DV="$HOME/projects"
        export USRHOME_DIR_PUB="$HOME/devpub"
        export USRHOME_DIR_PRIV="$HOME/devpriv"

        # The last one is USRHOME_defines the root of the usrhome directory
        # It is first set by execution of setup/setup-usrhome.
        export USRHOME_DIR="$HOME/projects/usrhome"
        ;;

    *)
        echo "This host, $(hostname -s), is not supported!"
        echo "Please update /usrcfg/setfor-zsh-config.zsh"
        ;;
esac
...
#
# The following environment variables identify the location of 4 important
# directories in USRHOME_DIR_ variables.
#
